                    ...
                    <div className="bg-white p-2 rounded border-2 border-blue-300">
                        ...
                        {selectedEntity.type === 'ellipse' && (
                            <div className="mt-3 border-t pt-2">
                                ...
                                <div className="prop-row"><label className="prop-label">終了角°</label><NumberInput value={selectedEntity.endAngle !== undefined ? selectedEntity.endAngle : 360} onChange={e => updateEntity('endAngle', ((Number(e.target.value) % 360) + 360) % 360)} className="prop-input" /></div>
